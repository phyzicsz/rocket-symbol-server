...
/**
 * Defines constants used by the WorldWind symbology classes, including symbolic
...
public interface SymbologyConstants {
    ...
    /**
     * The MIL-STD-2525 Additional Information modifier field ID. The meaning of
     * this field is implementation specific. See MIL-STD-2525 section 5.3.4.10
     * (page 29), table IV (pages 22-24) and table XIV (pages 46-47). When used
     * as a key, the corresponding value must be a string containing up to 20
     * characters.
     */
    final String ADDITIONAL_INFORMATION = "H";

    /**
     * The MIL-STD-2525 Altitude/Depth modifier field ID. Indicates either
     * altitude flight level, depth for submerged objects, or height of
     * equipment or structures on the ground. See MIL-STD-2525 section 5.5.2.5
     * (page 40-41), table IV (pages 22-24) and table XIV (pages 46-47). When
     * used as a key, the corresponding value must be a string containing up to
     * 14 characters.
     */
     ...
     * Indicates the auxiliary equipment code associated with a MIL-STD-2525
     * symbol (SIDC positions 11-12). A symbol's auxiliary equipment is
     * currently used to define towed sonar arrays. See MIL-STD-2525C section
     * 5.3.4.4 (page 27) and table VII (page 28). When used as a key, the
     * corresponding value must be one of the following:
     * <ul> <li>AUXILIARY_EQUIPMENT_TOWED_SONAR_ARRAY_SHORT</li>
     * <li>AUXILIARY_EQUIPMENT_TOWED_SONAR_ARRAY_LONG</li>
     * </ul>
     * <p>
     * The auxiliary equipment codes are the same for all symbology schemes that
    ...
    /**
     * The MIL-STD-2525 Towed Sonar Array (Long) auxiliary equipment code. See
     * MIL-STD-2525C section 5.3.4.4 (page 27) and table VII (page 28).
     */
    final String AUXILIARY_EQUIPMENT_TOWED_SONAR_ARRAY_LONG = "NL";
    /**
     * The MIL-STD-2525 Towed Sonar Array (Short) auxiliary equipment code. See
     * MIL-STD-2525C section 5.3.4.4 (page 27) and table VII (page 28).
     */
    ...
    /**
     * The MIL-STD-2525 Ground battle dimension code. Indicates a symbol who's
     * mission area is on the land surface. See MIL-STD-2525C section 5.3.1.3
     * (page 17).
     */
    final String BATTLE_DIMENSION_GROUND = "G";
    /**
     * The MIL-STD-2525 Other battle dimension code. Indicates a symbol who's
     * mission area is not one of the pre-defined areas: space, air, ground, sea
     * surface, sea subsurface, or special operations forces. See MIL-STD-2525C
     * section 5.3.1.3 (page 17).
     */
    final String BATTLE_DIMENSION_OTHER = "X";
    /**
     * The MIL-STD-2525 Sea Subsurface battle dimension code. Indicates a symbol
     * who's mission area is below the sea surface. See MIL-STD-2525C section
     * 5.3.1.3 (page 17).
     */
    final String BATTLE_DIMENSION_SEA_SUBSURFACE = "U";
    /**
     * The MIL-STD-2525 Sea Surface battle dimension code. Indicates a symbol
     * who's mission area is on the sea surface. See MIL-STD-2525C section
     * 5.3.1.3 (page 17).
     */
    ...
    /**
     * The MIL-STD-2525 Space battle dimension code. Indicates a symbol who's
     * mission area is at the lower boundary of the Earth's ionosphere or above.
     * See MIL-STD-2525C section 5.3.1.3 (page 17).
     */
    final String BATTLE_DIMENSION_SPACE = "P";
    /**
     * The MIL-STD-2525 Unknown battle dimension code. Indicates a symbol who's
     * battle dimension either has not been determined or cannot be determined.
     * See MIL-STD-2525C section 5.3.1.3 (page 17).
     */
    ...
    /**
     * The MIL-STD-2525 Combat Effectiveness modifier field ID. Indicates a
     * unit's effectiveness or an installation's capability. See MIL-STD-2525
     * section 5.3.4.10 (page 29), table IV (pages 22-24) and table XIV (pages
     * 46-47). When used as a key, the corresponding value must be a string
     * containing up to 5 characters.
     */
     ...
     * in the DTG format "DDHHMMSSZMONYYYY" or "O/O" for on order. See
     * MIL-STD-2525 section 5.5.2.6 (page 41-42), table IV (pages 22-24) and
     * table XIV (pages 46-47). When used as a key, the corresponding value must
     * be a string containing up to 16 characters.
     */
     ...
     * meters (radius, length, width, etc). See MIL-STD-2525 section 5.5.2 (page
     * 38), table XI (pages 38-39) and table XIV (pages 46-47). When used as a
     * key, the corresponding value must be a Double.
     */
    final String DISTANCE = "AM";

    /**
     * The MIL-STD-2525 Echelon modifier field ID. Indicates the echelon code
     * associated with a MIL-STD-2525 symbol (SIDC position 12). A symbol's
     * echelon defines the command level of a unit represented by the symbol.
     * See MIL-STD-2525 section 5.3.4.2 (page 25), section 5.5.2.2 (page 40),
     * and table V (pages 25-26). When used as a key, the corresponding value
     * must be one of the following:
     * <ul> <li>ECHELON_TEAM_CREW</li> <li>ECHELON_SQUAD</li>
     * <li>ECHELON_SECTION</li>
     * <li>ECHELON_PLATOON_DETACHMENT</li>
     * <li>ECHELON_COMPANY_BATTERY_TROOP</li>
     * <li>ECHELON_BATTALION_SQUADRON</li>
     * <li>ECHELON_REGIMENT_GROUP</li> <li>ECHELON_BRIGADE</li>
     * <li>ECHELON_DIVISION</li> <li>ECHELON_CORPS</li>
     * <li>ECHELON_ARMY</li> <li>ECHELON_ARMY_GROUP_FRONT</li>
     * <li>ECHELON_REGION</li> <li>ECHELON_COMMAND</li> </ul>
     * <p>
     * The echelon codes are the same for all symbology schemes that use them,
     * and are defined in each appendix of the MIL-STD-2525C specification:
     * <ul> <li>Warfighting - section A.5.2.1.f (page 51) and table A-II (pages
     * 52-54)</li> <li>Tactical Graphics - section B.5.2.1.f (page 304) and
     * table B-II (page 305)</li> <li>Stability Operations - section E.5.2.1.f
     * (page 991) and table E-II (pages 992-994)</li> </ul>
     */
    final String ECHELON = "B";
    /**
     * The MIL-STD-2525 Army echelon code. See MIL-STD-2525 section 5.3.4.2
     * (page 25), section 5.5.2.2 (page 40), and table V (pages 25-26).
     */
    final String ECHELON_ARMY = "K";
    /**
     * The MIL-STD-2525 Army Group/Front echelon code. See MIL-STD-2525 section
     * 5.3.4.2 (page 25), section 5.5.2.2 (page 40), and table V (pages 25-26).
     */
    final String ECHELON_ARMY_GROUP_FRONT = "L";
    /**
     * The MIL-STD-2525 Battalion/Squadron echelon code. See MIL-STD-2525
     * section 5.3.4.2 (page 25), section 5.5.2.2 (page 40), and table V (pages
     * 25-26).
     */
    final String ECHELON_BATTALION_SQUADRON = "F";
    /**
     * The MIL-STD-2525 Brigade echelon code. See MIL-STD-2525 section 5.3.4.2
     * (page 25), section 5.5.2.2 (page 40), and table V (pages 25-26).
     */
    final String ECHELON_BRIGADE = "H";
    /**
     * The MIL-STD-2525 Command echelon code. See MIL-STD-2525 section 5.3.4.2
     * (page 25), section 5.5.2.2 (page 40), and table V (pages 25-26).
     */
    final String ECHELON_COMMAND = "N";
    /**
     * The MIL-STD-2525 Company/Battery/Troop echelon code. See MIL-STD-2525
     * section 5.3.4.2 (page 25), section 5.5.2.2 (page 40), and table V (pages
     * 25-26).
     */
    final String ECHELON_COMPANY_BATTERY_TROOP = "E";
    /**
     * The MIL-STD-2525 Corps echelon code. See MIL-STD-2525 section 5.3.4.2
     * (page 25), section 5.5.2.2 (page 40), and table V (pages 25-26).
     */
    final String ECHELON_CORPS = "J";
    /**
     * The MIL-STD-2525 Division echelon code. See MIL-STD-2525 section 5.3.4.2
     * (page 25), section 5.5.2.2 (page 40), and table V (pages 25-26).
     */
    final String ECHELON_DIVISION = "I";
    /**
     * The MIL-STD-2525 Platoon/Detachment echelon code. See MIL-STD-2525
     * section 5.3.4.2 (page 25), section 5.5.2.2 (page 40), and table V (pages
     * 25-26).
     */
    final String ECHELON_PLATOON_DETACHMENT = "D";
    /**
     * The MIL-STD-2525 Section echelon code. See MIL-STD-2525 section 5.3.4.2
     * (page 25), section 5.5.2.2 (page 40), and table V (pages 25-26).
     */
    final String ECHELON_SECTION = "C";
    /**
     * The MIL-STD-2525 Squad echelon code. See MIL-STD-2525 section 5.3.4.2
     * (page 25), section 5.5.2.2 (page 40), and table V (pages 25-26).
     */
    final String ECHELON_SQUAD = "B";
    /**
     * The MIL-STD-2525 Team/Crew echelon code. See MIL-STD-2525 section 5.3.4.2
     * (page 25), section 5.5.2.2 (page 40), and table V (pages 25-26).
     */
    final String ECHELON_TEAM_CREW = "A";
    /**
     * The MIL-STD-2525 Regiment/Group echelon code. See MIL-STD-2525 section
     * 5.3.4.2 (page 25), section 5.5.2.2 (page 40), and table V (pages 25-26).
     */
    final String ECHELON_REGIMENT_GROUP = "G";
    /**
     * The MIL-STD-2525 Region echelon code. See MIL-STD-2525 section 5.3.4.2
     * (page 25), section 5.5.2.2 (page 40), and table V (pages 25-26).
     */
     ...
     * the following: <ul> <li>"A" - completely reliable</li> <li>"B" - usually
     * reliable</li> <li>"C" - fairly reliable</li> <li>"D" - not usually
     * reliable</li>
     * <li>"E" - unreliable</li> <li>"F" - reliability cannot be judged</li>
     * </ul>
     * <p>
     * The second character indicates the credibility rating, and must be one of
     * the following: <ul> <li>"1" - confirmed by other sources</li> <li>"2" -
     * probably true</li> <li>"3" - possibly true</li> <li>"4" - doubtfully
     * true</li>
     * <li>"5" - improbable</li> <li>"6" - truth cannot be judged</li> </ul>
     * <p>
     * See FM 34-3, Intelligence Analysis, March 1990, pages 2-13 through 2-17
     * for complete definitions of evaluation ratings.
     */
    final String EVALUATION_RATING = "J";

    /**
     * The MIL-STD-2525 Feint/Dummy Indicator modifier field ID. Indicates
     * whether a MIL-STD-2525 symbol's represented object is a feint/dummy. A
     * feint/dummy symbol indicates a unit, equipment, or installation designed
     * to draw the enemy's attention away from the area of the main attack. When
     * a marked as a feint/dummy, a symbol's graphic is changed to include a
     * dashed inverted "V" above its frame. See MIL-STD-2525 section 5.3.4.7
     * (page 28). When used as a key, the corresponding value must be a boolean
     * value. The value is <code>true</code> if the symbol's represented object
     * is a feint/dummy, and <code>false</code> otherwise.
     * <p>
     ...
     * object. See MIL-STD-2525 table XI (pages 38-39) and table XIV (pages
     * 46-47).When used as a key, the corresponding value must be a string of
     * any length.
     */
     ...
     * side of its frame. See MIL-STD-2525 section 5.3.4.8 (page 29). When used
     * as a key, the corresponding value must be a boolean value. The value is
     * <code>true</code> if the symbol's represented object is a headquarters,
     ...
     * or title of higher echelon command. See MIL-STD-2525 section 5.3.4.10
     * (page 29), table IV (pages 22-24) and table XIV (pages 46-47). When used
     * as a key, the corresponding value must be the string containing up to 21
     * characters.
     */
     ...
     * depict hostile entities. See MIL-STD-2525 section 5.5.1.1 (page 37). This
     * modifier is displayed automatically on graphics that represent hostile
     ...
     * identification mode or code. See MIL-STD-2525 section 5.3.4.10 (page 29),
     * table IV (pages 22-24) and table XIV (pages 46-47). When used as a key,
     * the corresponding value must be a string containing up to 5 characters.
     */
     ...
     * is a military camp or base. See MIL-STD-2525 section 5.3.4.5 (page 28).
     ...
     * <p>
     * The installation codes are the same for all symbology schemes that use
     * them, and are defined in each appendix of the MIL-STD-2525C
     * specification:
     * <ul> <li>Warfighting - section A.5.2.1.f (page 51) and table A-II (pages
     * 52-54)</li> <li>Stability Operations - section E.5.2.1.f (page 991) and
     * table E-II (pages 992-994)</li> <li>Emergency Management - section
     * G.5.5.5 (page 1030) and table G-II (page 1032)</li> </ul>
     */
    final String INSTALLATION = "AC";
    /**
     * The MIL-STD-2525 Normal (as opposed to Feint/Dummy) installation code.
     * See MIL-STD-2525 section 5.3.4.5 (page 28).
     */
    final String INSTALLATION_NORMAL = "H-";
    /**
     * The MIL-STD-2525 Feint/Dummy installation code. See MIL-STD-2525 section
     * 5.3.4.5 (page 28).
     */
     ...
     * location in any desired display format. See MIL-STD-2525 section 5.3.4.10
     * (page 29), table IV (pages 22-24) and table XIV (pages 46-47). When used
     * as a key, the corresponding value must be a string containing up to 19
     * characters.
     */
     ...
     * positions 11-12). A symbol's mobility defines the mobility feature of the
     * represented object, other than mobility intrinsic to the represented
     * object. Mobility codes are currently used only to describe mobility
     * features of equipment. See MIL-STD-2525 section 5.3.4.3 (page 26) and
     * table VI (pages 26-27). When used as a key, the corresponding value must
     * be one of the following:
     * <ul> <li>MOBILITY_WHEELED</li> <li>MOBILITY_CROSS_COUNTRY</li>
     * <li>MOBILITY_TRACKED</li>
     * <li>MOBILITY_WHEELED_TRACKED_COMBINATION</li> <li>MOBILITY_TOWED</li>
     * <li>MOBILITY_RAIL</li>
     * <li>MOBILITY_OVER_THE_SNOW</li> <li>MOBILITY_SLED</li>
     * <li>MOBILITY_PACK_ANIMALS</li> <li>MOBILITY_BARGE</li>
     * <li>MOBILITY_AMPHIBIOUS</li> </ul>
     * <p>
     * The mobility codes are the same for all symbology schemes that use them,
     * and are defined in each appendix of the MIL-STD-2525C specification:
     * <ul> <li>Warfighting - section A.5.2.1.f (page 51) and table A-II (pages
     * 52-54)</li> <li>Emergency Management - section G.5.5.5 (page 1030) and
     * table G-II (page 1032)</li> </ul>
     */
    final String MOBILITY = "R";
    /**
     * The MIL-STD-2525 Amphibious Mobility mobility code. See MIL-STD-2525
     * section 5.3.4.3 (page 26) and table VI (pages 26-27).
     */
    final String MOBILITY_AMPHIBIOUS = "MY";
    /**
     * The MIL-STD-2525 Barge mobility code. See MIL-STD-2525 section 5.3.4.3
     * (page 26) and table VI (pages 26-27).
     */
    final String MOBILITY_BARGE = "MX";
    /**
     * The MIL-STD-2525 Cross Country mobility code. See MIL-STD-2525 section
     * 5.3.4.3 (page 26) and table VI (pages 26-27).
     */
    final String MOBILITY_CROSS_COUNTRY = "MP";
    /**
     * The MIL-STD-2525 Over The Snow mobility code. See MIL-STD-2525 section
     * 5.3.4.3 (page 26) and table VI (pages 26-27).
     */
    final String MOBILITY_OVER_THE_SNOW = "MU";
    /**
     * The MIL-STD-2525 Pack Animals mobility code. See MIL-STD-2525 section
     * 5.3.4.3 (page 26) and table VI (pages 26-27).
     */
    final String MOBILITY_PACK_ANIMALS = "MW";
    /**
     * The MIL-STD-2525 Rail mobility code. See MIL-STD-2525 section 5.3.4.3
     * (page 26) and table VI (pages 26-27).
     */
    final String MOBILITY_RAIL = "MT";
    /**
     * The MIL-STD-2525 Sled mobility code. See MIL-STD-2525 section 5.3.4.3
     * (page 26) and table VI (pages 26-27).
     */
    final String MOBILITY_SLED = "MV";
    /**
     * The MIL-STD-2525 Towed mobility code. See MIL-STD-2525 section 5.3.4.3
     * (page 26) and table VI (pages 26-27).
     */
    final String MOBILITY_TOWED = "MS";
    /**
     * The MIL-STD-2525 Tracked mobility code. See MIL-STD-2525 section 5.3.4.3
     * (page 26) and table VI (pages 26-27).
     */
    final String MOBILITY_TRACKED = "MQ";
    /**
     * The MIL-STD-2525 Wheeled/Limited Cross Country mobility code. See
     * MIL-STD-2525 section 5.3.4.3 (page 26) and table VI (pages 26-27).
     */
    final String MOBILITY_WHEELED = "MO";
    /**
     * The MIL-STD-2525 Wheeled And Tracked Combination mobility code. See
     * MIL-STD-2525 section 5.3.4.3 (page 26) and table VI (pages 26-27).
     */
     ...
     * headquarters. Appears in SIDC position 11. See {@link #FEINT_DUMMY} and
     * {@link #HEADQUARTERS}.
     */
     ...
     * Appears in SIDC position 11. See {@link #FEINT_DUMMY} and
     * {@link #TASK_FORCE}.
     */
     ...
     * force, and a headquarters. Appears in SIDC position 11. See {@link #FEINT_DUMMY},
     ...
     * headquarters. Appears in SIDC position 11. See {@link #TASK_FORCE} and
     * {@link #HEADQUARTERS}.
     */
     ...
     * items associated with a MIL-STD-2525 symbol. See MIL-STD-2525 section
     * 5.3.4.10 (page 29), table IV (pages 22-24) and table XIV (pages 46-47).
     * When used as a key, the corresponding value must be a numeric value
     * indicating the number of items present.
     */
     ...
     * <ul> <li>REINFORCED to indicate that the unit is reinforced</li>
     ...
     * corresponding value must be one of the following:
     * <ul> <li>SCHEME_WARFIGHTING</li> <li>SCHEME_TACTICAL_GRAPHICS</li>
     * <li>SCHEME_METOC</li>
    ...
    /**
     * The MIL-STD-2525 Signals Intelligence (SIGINT) scheme code. See
     * MIL-STD-2525C table D-I (page 964).
     */
    final String SCHEME_INTELLIGENCE = "I";
    /**
     * The MIL-STD-2525 Meteorological and Oceanographic (METOC) scheme code.
     * See MIL-STD-2525C table C-I (page 763).
     */
    final String SCHEME_METOC = "W";
    /**
     * The MIL-STD-2525 Stability Operations (SO) scheme code. See MIL-STD-2525C
     * table E-I (page 991).
     */
     ...
     * as Units, Equipment, and Installations (UEI). See MIL-STD-2525C table A-I
     * (page 51).
     */
     ...
     * detectable electronic signatures from hostile equipment. See MIL-STD-2525
     * section 5.3.4.10 (page 29), table IV (pages 22-24) and table XIV (pages
     * 46-47). When used as a key, the corresponding value must be the string
     * "!".
     */
     ...
     * displayed inside the symbol's frame. See MIL-STD-2525 section 5.3.4.10
     * (page 29), table IV (pages 22-24) and table XIV (pages 46-47). When used
     * as a key, the corresponding value must be a string containing up to 9
     * characters.
     */
     ...
     * as defined in MIL-STD-6040. See MIL-STD-2525 section 5.3.4.10 (page 29),
     * table IV (pages 22-24) and table XIV (pages 46-47). When used as a key,
     ...
     * direction of movement or intended movement of an object. See MIL-STD-2525
     * section 5.3.4.11.3 (page 30-31), table IV (pages 22-24) and table XIV
     * (pages 46-47). When used as a key, the corresponding value must be a
     * numeric value indicating an amount to scale the Direction of Movement
     * modifier line as a ratio of the line's original length. The specified
     * scale is a floating point number greater than 0.0: values less than 1.0
     * make the line shorter, while values greater than 1.0 make the line
     * longer.
     */
     ...
     * field is implementation specific. See MIL-STD-2525 section 5.3.4.10 (page
     * 29), table IV (pages 22-24) and table XIV (pages 46-47). When used as a
     * key, the corresponding value must be a string containing up to 20
     * characters.
     */
     ...
     * See MIL-STD-2525C section 3.2.2 (page 7).
     */
     ...
     * condition. See MIL-STD-2525C section 3.2.41 (page 10), section 5.3.1.4
     * (pages 17-18), and tables III and III-2 (pages 18-17). The recognized
     * values depend on the specific MIL-STD-2525 symbology scheme the symbol
     * belongs to, and are defined in each appendix of the MIL-STD-2525C
     * specification:
     * <p>
     * <strong>Warfighting, Signals Intelligence, Stability Operations</strong>
     * <br> See MIL-STD-2525C section A.5.2.1.d (page 51), table A-I (page 51),
     * section D.5.2.1.d (page 964), table D-I (page 964), section E.5.2.1.d
     * (page 991), and table E-I (page 991).
     * <ul> <li>STATUS_ANTICIPATED</li> <li>STATUS_PRESENT</li>
     * <li>STATUS_PRESENT_FULLY_CAPABLE</li>
     * <li>STATUS_PRESENT_DAMAGED</li> <li>STATUS_PRESENT_DESTROYED</li>
     * <li>STATUS_PRESENT_FULL_TO_CAPACITY</li> </ul>
     * <p>
     * <strong>Tactical Graphics</strong> <br> See MIL-STD-2525C section
     * B5.2.1.d (page 304) and table B-I (page 305).
     * <ul> <li>STATUS_ANTICIPATED</li> <li>STATUS_SUSPECTED</li>
     * <li>STATUS_PRESENT</li> <li>STATUS_KNOWN</li> </ul>
     * <p>
     * <strong>Emergency Management</strong> <br> See MIL-STD-2525C section
     * G.5.2.4 (page 1028) and table G-I (page 1032).
     ...
     * location. See MIL-STD-2525C section 5.3.1.4 (pages 17-18).
     */
    final String STATUS_ANTICIPATED = "A";
    /**
     * The MIL-STD-2525 Known status code. See MIL-STD-2525C table B-I (page
     * 305).
     */
    final String STATUS_KNOWN = "K";
    /**
     * The MIL-STD-2525 Present/Fully Capable status code. Indicates a symbol
     * who's represented object currently exists at the symbol's location. See
     * MIL-STD-2525C section 5.3.1.4 (pages 17-18).
     */
     ...
     * represented object is suspected to exist at the symbol's location. See
     * MIL-STD-2525C section 5.3.1.4 (pages 17-18).
     */
     ...
     * to included in a TacticalGraphic. See MIL-STD-2525 section 5.5.2 (page
     * 38), table XI (pages 38-39) and table XIV (pages 46-47). When used as a
     * key, the corresponding value must be an {@link TacticalSymbol}.
     */
     ...
     * bracket above its echelon. See MIL-STD-2525 section 5.3.4.6 (page 28).
     * When used as a key, the corresponding value must be a boolean value. The
     * value is <code>true</code> if the symbol's represented object is a task
     ...
     * See MIL-STD-2525 section 5.3.4.1 (page 25), table IV (pages 22-24) and
     * table XIV (pages 46-47). When used as a key, the corresponding value must
     * be a string containing up to 24 characters.
     */
    final String TYPE = "V";
     ...
     * number when used with SIGINT symbology. See MIL-STD-2525 section 5.3.4.10
     * (page 29), table IV (pages 22-24) and table XIV (pages 46-47). When used
     * as a key, the corresponding value must be a string containing up to 21
     * characters.
     */
