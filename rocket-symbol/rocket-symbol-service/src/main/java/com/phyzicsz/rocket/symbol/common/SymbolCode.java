 ...
 * fields of a MIL-STD-2525 symbol identification code (SIDC). A SymbolCode can
 * either be created by parsing a 15-character symbol code string or by creating
 * an empty SymbolCode and manually specifying its fields.
 * <p>
 * To parse a symbol code string, construct a new SymbolCode passing in the
 * identifier string as the sole argument. SymbolCode validates and parses the
 * string, and populates its fields according to the contents of the string. If
 * any field in the code is unrecognized SymbolCode throws an exception and
 * indicates the problematic fields in the exception's message. After parsing,
 * each field can be accessed by calling the appropriate accessor methods (for
 * example: getScheme/setScheme). SymbolCodes supports the following fields:
 * <ul> <li>Coding Scheme</li> <li>Standard Identity</li> <li>Battle
 * Dimension</li> <li>Category</li> <li>Function ID</li> <li>Symbol
 * Modifier</li> <li>Echelon</li> <li>Status</li> <li>Country Code</li>
 * <li>Order of Battle</li>
 * </ul>
 * <p>
 * Which fields are populated after parsing a symbol code depends on the
 * MIL-STD-2525 symbology set the symbol code belongs to:
 * <table border="1"> <caption style="font-weight: bold;">Populated
 * Fields</caption><tr><th>Symbology Set</th><th>Coding Scheme</th><th>Standard
 * Identity</th><th>Battle
 * Dimension</th><th>Category</th><th>Status</th><th>Function ID</th><th>Symbol
 * Modifier</th><th>Echelon</th><th>Country Code</th><th>Order of
 * Battle</th></tr>
...
public class SymbolCode extends KVStore {
    ...
    /**
     * Creates a new symbol code, but otherwise does nothing. All fields are
    ...
    /**
     * Specifies this symbol code's Coding Scheme field. A symbol code's Coding
     * Scheme defines the specific MIL-STD-2525 symbology set that it belongs
     * to. The value must be <code>null</code> or one of the following:
    ...
    /**
     * Specifies this symbol code's Standard Identity field. A symbol code's
     * Standard Identity defines the threat posed by the object being
     * represented. The value must be <code>null</code> or one of the following:
    ...
    /**
     * Specifies this symbol code's Battle Dimension field. A symbol code's
     * Battle Dimension defines the primary mission area for the object being
     * represented. The value must be <code>null</code> or one of the following:
    ...
    /**
     * Specifies this symbol code's Category field. The meaning of a symbol
     * code's Category and the recognized values depend on the specific
    ...
    /**
     * Specifies this symbol code's Status/Operational Condition field. A symbol
     * code's Status defines whether the represented object exists at the time
     * the symbol was generated, or is anticipated to exist in the future.
     * Additionally, a symbol code's Status can define its operational
     * condition. The recognized values depend on the specific MIL-STD-2525
     * symbology scheme the symbol code belongs to:
     * <p>
    ...
    /**
     * Specifies this symbol code's Function ID field. The Function IDs are
     * unique to each symbology schemes that uses them, and are defined in each
    ...
    /**
     * Specifies this symbol code's Symbol Modifier field. The Symbol Modifier
     * defines what graphic symbol modifiers should be displayed around the
     * symbol's icon such as echelon, headquarters, task force, feint/dummy,
     * installation, equipment mobility, and auxiliary equipment. The recognized
     * values depend on the specific MIL-STD-2525 symbology scheme the symbol
     * code belongs to, and are defined in each appendix of the MIL-STD-2525C
     * specification:
    ...
    /**
     * Specifies this symbol code's Echelon field. A symbol code's Echelon
     * defines the command level of a unit represented by the symbol. The value
     * must be <code>null</code> or one of the following:
     ...
     * target="_blank">ISO 3166-1</a> for a definition of valid Country Codes.
     * The Country Codes are the same for all symbology schemes that use them.
     *
    ...
    /**
     * Specifies this symbol code's Order of Battle field. A symbol code's Order
     * of Battle provides additional information about the symbol in the
     * operational environment. The recognized values depend on the specific
     * MIL-STD-2525 symbology scheme the symbol code belongs to:
     * <p>
    ...
    /**
     * Specifies this symbol code's Static/Dynamic field. This field is used by
     * graphics in the Meteorological and Oceanographic scheme. Valid values are
     * STATIC and DYNAMIC.
     *
    ...
    /**
     * Specifies this symbol code's Graphic Type field. This field is used by
     * graphics in the Meteorological and Oceanographic scheme. Valid values are
     * GRAPHIC_TYPE_POINT, GRAPHIC_TYPE_LINE, GRAPHIC_TYPE_AREA.
     *
     ...
     * corresponding to this SymbolCode's current field values. Fields that are
     * not part of this SymbolCode's current Coding Scheme are ignored. Fields
     * that are unspecified or null are replaced with the MIL-STD-2525 unused
     * position character "-". Field values are either padded or trimmed to fit
     * their portion of the symbol code, adding unused characters to pad or
     * ignoring extra characters to trim.
     * <p>
     * This returns <code>null</code> if this SymbolCode's Coding Scheme is
     * <code>null</code> or unrecognized.
     *
    ...
    /**
     * Computes and returns the modifier key-value pairs associated with the
     * specified SymbolModifier code. This recognizes modifier codes used by the
     * Warfighting, Stability Operations, and Emergency Management symbology
     * schemes: echelon, headquarters, task force, feint/dummy, installation,
     * equipment mobility, and auxiliary equipment. This adds modifier keys only
     * for those modifiers present in the SymbolModifier field. Any modifiers
     * not in the SymbolModifier field are ignored. The following key-value
     * pairs are used to indicate each modifier:
     * <table border="1"> <caption style="font-weight: bold;">Key Value
     * Pairs</caption>
     ...
     * or <code>null</code></td></tr> <tr><td>Task
     * Force</td><td>SymbologyConstants.TASK_FORCE</td><td>Boolean.TRUE or
     * <code>null</code></td></tr>
     * <tr><td>Feint/Dummy</td><td>SymbologyConstants.FEINT_DUMMY</td><td>Boolean.TRUE
     ...
     * Mobility</td><td>SymbologyConstants.MOBILITY</td><td>See
     * {@link SymbologyConstants#MOBILITY}</td></tr> <tr><td>Auxiliary
     * Equipment</td><td>SymbologyConstants.AUXILIARY_EQUIPMENT</td><td>See
     * {@link SymbologyConstants#AUXILIARY_EQUIPMENT}</td></tr> </table>
     * <p>
     * Note that the installation modifier code indicates that an installation
     * is either a normal installation or a feint/dummy installation. In the
     * latter case, this also sets the modifier key
     * SymbologyConstants.FEINT_DUMMY to Boolean.TRUE. This provides a
     * consistent way to identify feint/dummy modifier status for both
     * units/equipment and installations.
     *
     * @param code the symbol modifier code to parse.
     * @param params a parameter list in which to place the modifier key-value
     * pairs, or <code>null</code> to allocate and return a new parameter list.
     *
     ...
     * Warfighting symbol codes contain the following fields: Coding Scheme,
     * Standard Identity, Battle Dimension, Status, Function ID, Symbol
     * Modifier, Country Code, Order of Battle. All fields except Function ID,
     * Symbol Modifier, Country Code and Order of Battle must be
     * non-<code>null</code>.
     * <p>
     * The Warfighting coding scheme is defined in MIL-STD-2525C table A-I (page
     * 51).
     *
     * @param symCode the symbol code to parse. Must be non-<code>null</code>
     * and have length of 15 or greater. Any characters after the 15th character
     ...
     * Tactical Graphic symbol codes contain the following fields: Coding
     * Scheme, Standard Identity, Category, Status, Function ID, Echelon,
     * Country Code, Order of Battle. All fields except Function ID, Echelon,
     * Country Code and Order of Battle must be non-<code>null</code>.
     * <p>
     * The Tactical Graphics coding scheme is defined in MIL-STD-2525C table B-I
     * (page 305).
     *
     * @param symCode the symbol code to parse. Must be non-<code>null</code>
     * and have length of 15 or greater. Any characters after the 15th character
     ...
     * coding scheme. METOC symbol codes are not currently supported, and this
     * returns a string indicating that the scheme is unrecognized.
     *
     * @param symCode the symbol code to parse. Must be non-<code>null</code>
     * and have length of 15 or greater. Any characters after the 15th character
     * are ignored.
     ...
     * Signals Intelligence symbol codes contain the following fields: Scheme,
     * Standard Identity, Battle Dimension, Status, Function ID, Country Code,
     * Order of Battle. All fields except Function ID, Country Code and Order of
     * Battle must be non-<code>null</code>.
     * <p>
     * The Signals Intelligence coding scheme is defined in MIL-STD-2525C table
     * D-I (page 964).
     *
     * @param symCode the symbol code to parse. Must be non-<code>null</code>
     * and have length of 15 or greater. Any characters after the 15th character
     ...
     * Stability Operations symbol codes contain the following fields: Scheme,
     * Standard Identity, Category, Status, Function ID, Symbol Modifier,
     * Country Code, Order of Battle. All fields except Function ID, Symbol
     * Modifier, Country Code and Order of Battle must be non-<code>null</code>.
     * <p>
     * The Stability Operations coding scheme is defined in MIL-STD-2525C table
     * E-I (page 991).
     *
     * @param symCode the symbol code to parse. Must be non-<code>null</code>
     * and have length of 15 or greater. Any characters after the 15th character
     ...
     * Emergency Management symbol codes contain the following fields: Scheme,
     * Standard Identity, Category, Status, Function ID, Symbol Modifier,
     * Country Code, Order of Battle. All fields except Function ID, Symbol
     * Modifier, Country Code and Order of Battle must be non-<code>null</code>.
     * <p>
     * The Emergency Management coding scheme is defined in MIL-STD-2525C table
     * G-I (page 1032).
     *
     * @param symCode the symbol code to parse. Must be non-<code>null</code>
     * and have length of 15 or greater. Any characters after the 15th character
     ...
     * code (SIDC) from this SymbolCode's current field values. Fields that are
     * not part of this SymbolCode's current Coding Scheme are ignored. Fields
     * that are unspecified or null are replaced with the MIL-STD-2525 unused
     * position character "-". Field values are either padded or trimmed to fit
     * their portion of the symbol code, adding unused characters to pad or
     ...
     * Warfighting coding scheme. Warfighting symbol codes contain the following
     * fields: Coding Scheme, Standard Identity, Battle Dimension, Status,
     * Function ID, Symbol Modifier, Country Code, Order of Battle.
     * <p>
     * The Warfighting coding scheme is defined in MIL-STD-2525C table A-I (page
     * 51).
     *
    ...
    /**
     * Composes a 15-character symbol identification code (SIDC) for the
     * Tactical Graphics coding scheme. Tactical Graphics symbol codes contain
     * the following fields: Coding Scheme, Standard Identity, Category, Status,
     * Function ID, Echelon, Country Code, Order of Battle.
     * <p>
     * The Tactical Graphics coding scheme is defined in MIL-STD-2525C table B-I
     * (page 305).
     *
    ...
    /**
     * Composes a 15-character symbol identification code (SIDC) for the
     * Meteorological and Oceanographic coding scheme. METOC symbol codes
     * contain the following fields: Coding Scheme, Category, Static/Dynamic,
     * Function ID, Graphic Type.
     * <p>
     * The Meteorological and Oceanographic coding scheme is defined in
     * MIL-STD-2525C table C-I (page 763).
     *
     * @return the MIL-STD-2525 15-character symbol identification code (SIDC)
     ...
     * Intelligence coding scheme. Signals Intelligence symbol codes contain the
     * following fields: Scheme, Standard Identity, Battle Dimension, Status,
    ...
    /**
     * Composes a 15-character symbol identification code (SIDC) for the
     * Stability Operations coding scheme. Stability Operations symbol codes
     * contain the following fields: Scheme, Standard Identity, Category,
     * Status, Function ID, Symbol Modifier, Country Code, Order of Battle.
     * <p>
     * The Stability Operations coding scheme is defined in MIL-STD-2525C table
     * E-I (page 991).
     *
    ...
    /**
     * Composes a 15-character symbol identification code (SIDC) for the
     * Emergency Management coding scheme. Emergency Management symbol codes
     * contain the following fields: Standard Identity, Category, Status,
     * Function ID, Symbol Modifier, Country Code, Order of Battle.
     * <p>
     * The Emergency Management coding scheme is defined in MIL-STD-2525C table
     * G-I (page 1032).
     ...
     * If the value is shorter than the specified length, this appends the
     * MIL-STD-2525 unused character "-" to fill the unused characters. If the
     * value is longer than the specified length, this ignores the extra
     * characters. If the value is <code>null</code> or empty, this appends
     * unused characters to fill the entire space used by the field.
     *
    ...
    /**
     * Indicates whether the specified field value is empty. This returns
     * <code>true</code> if the specified value is <code>null</code>, is the
     * empty string, or is filled entirely with the unused character "-".
     *
